...
<header class="flex">
    ...
    <div class="collapse navbar-collapse" id="toggleMobileMenu">
            <ul class="list-style flex navbar-nav mt-3">
                <li><a class="active" href="../pages/index.php" id="home">Home</a></li>
                <li><a class="" href="../pages/eventos.php" id="eventos">Eventos</a></li>
                <li><a class="" href="../pages/usuarios.php" id="usuarios">Usuários</a></li>
    ...
    <main class="bg-grey">
        ...
        <div class="flex">
            <div class="container flex-colum flex-column-evenly ">
                ...
                <p class="bem-vindo">Olá <span class="usuarios">Igor Gonçalves</span>, selecione uma das opções abaixo:</p>
                ...
                <div class="flex">
                    ...
                    <a href="./relatorios.php#footer" class="link-decoration" >
